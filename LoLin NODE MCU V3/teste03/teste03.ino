...
String request = client.readStringUntil('.'); //FAZ A LEITURA DA PRIMEIRA LINHA DA REQUISIÇÃO
Serial.println(request); //ESCREVE A REQUISIÇÃO NA SERIAL
Serial.print(request[5]);
Serial.print(request[6]);
...
//client.println("<h1><center>Ola negro!</center></h1>"); //ESCREVE "Ola cliente!" NA PÁGINA
