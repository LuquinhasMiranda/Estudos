...
def odds_c9(velas): 
    ...
    return calc_odds(gale0, gale1, gale2, loss, holds, TargetPosition)
...
def odds_tabelado(velas):
    ...
    return calc_odds(gale0, gale1, gale2, erros, holds, TargetPosition)
...
def odds_milhao(velas):
    ...
    return calc_odds(gale0, gale1, gale2, loss, holds, TargetDirection)
    

def calc_odds( gale0, gale1, gale2, loss, holds, target):
    ...
    return total, acerto_odd, gale0_odd, gale1_odd, gale2_odd, loss_odd, hold_odd, target
